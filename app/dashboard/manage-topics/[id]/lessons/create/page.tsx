...
export default function CreateLessonPage({ params }: { params: Promise<{ id: string }> }) {
  const { getTopicById } = useTopics()
  const { addLesson, getLessonsByTopicId } = useLessons()
  ...
  const existingLessons = getLessonsByTopicId(topicId)
  ...
  // Generate lesson image based on topic
  useEffect(() => {
    if (topic) {
      const topicImages: Record<string, string> = {
        "General Info on Blockchain Tech": "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=400&h=225&fit=crop&crop=center",
        "Getting Started With Crypto": "https://images.unsplash.com/photo-1621761191319-c6fb62004040?w=400&h=225&fit=crop&crop=center",
        "Using MetaMask": "https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=400&h=225&fit=crop&crop=center",
        "Decentralised Finance (DeFi)": "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=400&h=225&fit=crop&crop=center",
        "Non-Fungible Tokens (NFTs)": "https://images.unsplash.com/photo-1640161704729-cbe966a08476?w=400&h=225&fit=crop&crop=center",
      }
      setFormData(prev => ({
        ...prev,
        image: topicImages[topic.title] || "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=400&h=225&fit=crop&crop=center"
      }))
    }
  }, [topic])
        ...
        <Card>
          <CardContent className="p-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              >
                <p>Enter your lesson content here. You can format text using the toolbar above.</p>
              </div>
            </div>
